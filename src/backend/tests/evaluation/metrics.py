...
class MathematicalAccuracyMetric(BaseMetric):
    ...
    def measure(self, test_case: LLMTestCase) -> float:
        ...
        if self.strict_matching:
            ...
            score = self._calculate_similarity_score(expected_normalized, actual_normalized)
            
            # Use LLM evaluation for complex cases if enabled
            if score < 0.8 and self.use_llm_evaluation:
                llm_score = self._llm_evaluate_math_equivalence(expected_answer, actual_clean)
    ...
    def _normalize_mathematical_answer(self, answer: str) -> str:
        ...
        prefixes_to_remove = ["answer:", "solution:", "result:", "the answer is", "final answer:"]
        ...
        if expected_nums and actual_nums:
            try:
                ...
                if abs(expected_val - actual_val) < 0.001:
                    return 0.95
                elif abs(expected_val - actual_val) / max(expected_val, actual_val) < 0.05:
                    return 0.8
...
class MathSolutionCompletenessMetric(BaseMetric):
    ...
    def _has_final_answer(self, text: str) -> bool:
        ...
        answer_indicators = [
            "answer", "solution", "result", "therefore", "thus", "final",
            "conclusion", "equals", "=", "is"
        ]
    ...
    def _has_solution_steps(self, text: str) -> bool:
        ...
        step_indicators = [
            "step", "first", "second", "next", "then", "now", "calculate",
            "substitute", "solve", "simplify", "factor"
        ]
    ...
    def _has_explanation(self, text: str) -> bool:
        ...
        explanation_indicators = [
            "because", "since", "due to", "reason", "explain", "why",
            "how", "method", "approach", "concept", "principle"
        ]
    ...
    def _has_mathematical_reasoning(self, text: str) -> bool:
        ...
        reasoning_indicators = [
            "theorem", "formula", "equation", "property", "rule",
            "law", "identity", "relationship", "pattern"
        ]
